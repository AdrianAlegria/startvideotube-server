...
def render_video(
    ...
    """
    # Escalar imagen y quemar subtítulos
    # Usamos -vf con dos filtros separados para máxima compatibilidad
    scale_filter = "scale=1080:1920:force_original_aspect_ratio=increase,crop=1080:1920"
    subtitle_filter = f"subtitles={srt_path}:force_style='FontName=Arial,FontSize=22,Bold=1,PrimaryColour=&H00FFFFFF,OutlineColour=&H00000000,BorderStyle=1,Outline=2,Shadow=1,MarginV=60,Alignment=2'"
